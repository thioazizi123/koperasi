    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="card-premium border-l-4 border-l-kop-blue-500">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-bold text-kop-blue-500 bg-kop-blue-50 px-2 py-1 rounded-full">+5% dari bulan lalu</span>
            </div>
        ...
        <div class="card-premium border-l-4 border-l-emerald-400">
            <div class="flex items-center justify-between mb-4">
                <div class="p-2 bg-emerald-50 rounded-lg text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 002-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                </div>
            </div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 font-bold text-slate-800">Rp {{ number_format($request->amount, 0, ',', '.') }}</td>
                        <td class="px-6 py-4 text-center">
                            <span class="px-3 py-1 bg-kop-blue-50 text-kop-blue-600 rounded-full text-[10px] font-bold uppercase tracking-tight">
                                {{ str_replace('_', ' ', $request->status) }}
                            </span>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('loans.show', $request->id) }}" class="text-kop-blue-500 hover:text-kop-blue-700 font-bold transition-colors">Detail</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-10 text-center text-slate-400 italic">Belum ada pengajuan pinjaman.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
